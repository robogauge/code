...
Follow the step-by-step setup guide in [setup.md](doc/setup.md).
...
> RoboGauge evaluation requires a separate server to be started. Refer to the [RoboGauge documentation](../RoboGauge/README.md).
...
- **Swap terrains**: Default terrain is `resources/robots/go2/stairs.xml`. Alternatives include `flat.xml`. Generate new terrains with [terrain_generator.py](resources/robots/go2/terrain_generator.py) (see also [unitree_mujoco/terrain_tool](https://github.com/unitreerobotics/unitree_mujoco/tree/main/terrain_tool)).

#### Results

| Flat | Stairs |
|--- | --- |
| ![eval flat](https://raw.githubusercontent.com/robogauge/picture-bed/refs/heads/main/go2_rl_gym/mujoco_eval_flat.gif) | ![eval stairs](https://raw.githubusercontent.com/robogauge/picture-bed/refs/heads/main/go2_rl_gym/mujoco_eval.gif) |
...
Follow the usage described in [unitree_cpp_deploy](../unitree_cpp_deploy/README.md).
